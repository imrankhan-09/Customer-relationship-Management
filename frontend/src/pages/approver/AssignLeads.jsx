          ...
          <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2">
            {leads.map(lead => (
              <div
                ...
                className={`flex items-center gap-4 p-4 rounded-2xl border-2 transition-all ${lead.status === 'assigned'
              ...
              >
                <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${lead.status === 'assigned'
                ...
                <div className="text-right">
                  <p className={`text-[10px] font-black uppercase tracking-widest ${lead.status === 'assigned' ? 'text-indigo-600' : 'text-emerald-600'
                    }`}>
          ...
          <div className="glass-card rounded-3xl p-8">
            ...
            <div className="space-y-3">
              {workers.map(worker => (
                <label
                  key={worker.id}
                  className={`flex items-center justify-between p-4 rounded-2xl border-2 transition-all cursor-pointer ${selectedWorker === worker.id
